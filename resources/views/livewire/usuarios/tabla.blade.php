<div class="card">
    <div class="card-header">
        <h3 class="card-title">Listado de Usuarios <a href="{{ route('usuarios.create') }}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Añadir</a></h3>
    </div>
    <!-- /.card-header -->
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Email: <br> <input class="form-control form-control-sm" type="text" placeholder=""
                            wire:model.live="email"></th>
                    <th>Nickname: <br> <input class="form-control form-control-sm" type="text" placeholder=""
                            wire:model.live="nickname"></th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center font-italic">Sin Registros coincidentes...</td>
                    </tr>
                @endforelse
